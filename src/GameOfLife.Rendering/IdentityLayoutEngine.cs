...
/// <summary>
/// A layout engine for Point2D identities where identity equals coordinate.
/// Creates layouts that return the identity directly as the position.
/// </summary>
public sealed class IdentityLayoutEngine : ILayoutEngine<Point2D, Point2D, RectangularBounds>
{
    /// <summary>
    ...
    public ILayout<Point2D, Point2D, RectangularBounds> CreateLayout(ITopology<Point2D> topology)
    {
